...
angular.module('posterApp').service('appData', function () {
	...
	var data = {
		...
		knownWords: [
			...
			{
				id: 'fish',
				words: ['מת', 'מוות', 'מות', 'מגעיל', 'געל', 'דוחה', 'מסריח', 'סרח', 'רפש', 'רקוב', 'רקב', 'מקולקל', 'קלקל', 'ים', 'חוף', 'לשחות', 'שחיתי', 'שחה', 'טיפש', 'הפוך', 'נפל', 'גוויה', 'סוף', 'רע', 'התייבשתי', 'יבש', 'משעמם', 'שעמום', 'עלוב', 'עלב', 'סנפיר', 'קרפיון', 'דג', 'טבע', 'שקע', 'גפילטע', 'אשכנזי', 'אשכנז', 'גוסס', 'גסס', 'לוזר', 'כשלון', 'כשלונ', 'מתעלף', 'עלף']
			},
			{
				id: 'heart',
				words: ['אהבה', 'אהב', 'נשק', 'נשיקות', 'חיבוק', 'חבק', 'חיבה', 'חמים', 'סימפטי', 'נשמה', 'כפרה', 'הורסת', 'הורס', 'אחלה', 'לב', 'מושלם', 'שלם', 'אלוף', 'אלופ', 'קרוב', 'יפה', 'מקסים', 'ידיד', 'מתגעגע', 'געגע', 'ליטוף', 'לטף', 'ליטפ', 'מעריץ', 'מעריצ', 'חמוד', 'לוהט', 'להט', 'מפנק', 'פינק']
			},
			{
				id: 'fuck',
			...
			{
				id: 'popsicle',
				words: ['ארטיק', 'עצוב', 'קרטיב', 'עצב', 'גלידה', 'בכי', 'בוכה', 'בכה', 'טרגדיה', 'דיכאון', 'דיכאונ', 'ממרר', 'כשלון', 'נכשל', 'כשל', 'בכיין', 'נמס', 'חם', 'חמסין', 'קיץ', 'נוזל', 'לשון', 'לשונ', 'ליקוק', 'ליקק', 'לקק', 'טעים', 'טעימ', 'שלולית', 'מתוק', 'נגמר', 'טיפה', 'קרח', 'סוכר', 'קפוא', 'דמעות', 'דמעה', 'קינוח', 'מוזר', 'עלוב', 'מפחד', 'גרוע']
			},
			{
				id: 'scream',
				words: ['פאניקה', 'פסיכי', 'היסטרי', 'חרד', 'משוגע', 'שגע', 'שיגע', 'מת', 'עצמות', 'עצם', 'תולעת', 'תולעים', 'רקוב', 'רקב', 'קבור', 'קבר', 'שלד', 'זומבי', 'נרקומן', 'מכור', 'מחוק', 'מטריף', 'גמור', 'וואו', 'האנגובר', 'לצעוק', 'צעק', 'מתפרק', 'מפחיד', 'פחד', 'אימה', 'משתק', 'דממה', 'בלהות', 'סיוט']
			},
			{
				id: 'teeth',
